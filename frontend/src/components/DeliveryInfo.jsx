...
const DeliveryInfo = () => {
  return (
    <div
      id="delivery"
      className="bg-gradient-to-br from-gray-50 to-cyan-50/30 dark:from-gray-900 dark:to-cyan-900/10 rounded-3xl p-8"
    >
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/2">
          ...
          <h2 className="prata-regular text-3xl text-cyan-500 mb-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              ...
              <br />
              Old Bodija, Lagos, Nigeria
            </p>
          </div>

          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm border border-cyan-100 dark:border-cyan-900">
            <h3 className="text-xl font-semibold text-cyan-500 mb-4 flex items-center gap-2">
            ...
            <ul className="space-y-3 text-gray-700 dark:text-gray-300">
              <li className="flex items-start">
                ...
                <span>
                  <strong>Lagos:</strong> 1-3 business days
                </span>
              </li>
              <li className="flex items-start">
                <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 mr-3"></div>
                <span>
                  <strong>Outside Lagos:</strong> 3-10 business days via God is
                  Good Logistics
                  <br />
                  <span className="text-sm text-cyan-700 mt-1 block">
              ...
              <li className="flex items-start">
                <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 mr-3"></div>
                <span>
                  <strong>Total Cost:</strong> Product cost + Delivery fee
                  <br />
                  <span className="text-sm text-cyan-700 mt-1 block">
        ...
        <div className="w-full md:w-1/2">
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 h-full shadow-sm border border-cyan-100 dark:border-cyan-900">
            <h3 className="text-xl font-semibold text-cyan-500 mb-6 flex items-center gap-2">
              Payment Options
            </h3>

            <div className="mb-8">
              <div className="flex items-center gap-3 mb-3">
                <h4 className="font-medium text-lg text-cyan-500">
              ...
              <div className="mt-4 bg-cyan-50 dark:bg-cyan-900/20 rounded-lg p-4 border border-cyan-100 dark:border-cyan-900">
                <h5 className="font-semibold text-cyan-500 mb-2">
                  Bank Transfer Details:
                </h5>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <span className="font-medium">Account Name:</span>
                  <span>Dolftech Nigeria Ltd</span>
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Secure payments via cards, bank transfers, or mobile money.
                <br />
                <span className="text-cyan-600 font-medium">
                  5% discount + priority processing
                </span>
              </p>
            </div>

            <div className="mt-8 pt-6 border-t border-cyan-100 dark:border-cyan-900">
              <h4 className="font-semibold text-cyan-500 mb-3">
                Important Notes:
              </h4>
              <ul className="text-gray-700 dark:text-gray-300 space-y-2 text-sm">
                <li className="flex items-start">
                  <div className="w-1.5 h-1.5 rounded-full bg-cyan-500 mt-2 mr-2"></div>
                  <span>
                    <strong>Payment required</strong> before order processing
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="w-1.5 h-1.5 rounded-full bg-cyan-500 mt-2 mr-2"></div>
                  <span>
                    Outside Lagos deliveries via{" "}
                    <strong>God is Good Logistics</strong>
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="w-1.5 h-1.5 rounded-full bg-cyan-500 mt-2 mr-2"></div>
                  <span>
                    Delivery fee calculated based on{" "}
                    <strong>distance + order value</strong>
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="w-1.5 h-1.5 rounded-full bg-cyan-500 mt-2 mr-2"></div>
                  <span>Free delivery for orders over ₦100,000 in Lagos</span>
                </li>
              </ul>
            </div>
          </div>
