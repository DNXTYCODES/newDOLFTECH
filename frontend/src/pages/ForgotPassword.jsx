...
const ForgotPassword = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            const response = await axios.post('https://scentdesignfsbackend.onrender.com/api/user/forgot-password', { email });
            // const response = await axios.post('https://edierechopsbackend.onrender.com/api/user/forgot-password', { email });
