          ...
          <div className="container mx-auto px-4 md:px-6 py-16 md:py-24 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-12 md:mb-0">
              ...
              <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-8">
                Need a laptop for work, school, gaming, or business? Want advice on the best tech for your budget? Our Ibadan-based Dolftech team is here for you. We know what matters: fast delivery, honest advice, and real results. Reach out and let’s help you get the right laptop, no stories.
              </p>
        ...
        <div className="container mx-auto px-4 md:px-6 py-12 md:py-20">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-purple-100 text-center hover:shadow-xl transition-shadow">
              <div className="mb-4"><FiMapPin className="text-3xl text-purple-600" /></div>
              <h3 className="prata-regular text-xl md:text-2xl font-bold mb-4 text-purple-900">Visit Us</h3>
              <div className="space-y-2 mb-6">
                <p className="text-gray-600 text-sm md:text-base">7 Oyesina Close, Opposite 7 Ibikunle Avenue,</p>
                <p className="text-gray-600 text-sm md:text-base">Old Bodija, Ibadan, Oyo State, Nigeria</p>
                <p className="text-gray-600 text-sm md:text-base">(Landmark: Close to Bodija Market)</p>
              </div>
              <a href="https://maps.google.com/?q=7+oyesina+close+ibadan" className="inline-block px-5 py-2 bg-purple-50 text-purple-600 rounded-lg hover:bg-purple-100 transition-colors text-sm md:text-base">Get Directions</a>
            </div>
            {/* Phone */}
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-purple-100 text-center hover:shadow-xl transition-shadow">
              <div className="mb-4"><FiPhone className="text-3xl text-purple-600" /></div>
              <h3 className="prata-regular text-xl md:text-2xl font-bold mb-4 text-purple-900">Call Us</h3>
              <div className="space-y-2 mb-6">
                <p className="text-gray-600 text-sm md:text-base">Customer Service: +234 802 829 3058</p>
                <p className="text-gray-600 text-sm md:text-base">WhatsApp: +234 802 829 3058</p>
                <p className="text-gray-600 text-sm md:text-base">We respond fast. No long story, just solutions.</p>
              </div>
              <a href="tel:+2348028293058" className="inline-block px-5 py-2 bg-purple-50 text-purple-600 rounded-lg hover:bg-purple-100 transition-colors text-sm md:text-base">Call Now</a>
            </div>
            {/* Hours */}
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-purple-100 text-center hover:shadow-xl transition-shadow">
              <div className="mb-4"><FiClock className="text-3xl text-purple-600" /></div>
              <h3 className="prata-regular text-xl md:text-2xl font-bold mb-4 text-purple-900">Business Hours</h3>
              <div className="space-y-2 mb-6">
                ...
                <p className="text-gray-600 text-sm md:text-base">Public Holidays: Call to confirm</p>
              </div>
              <a href="/appointment" className="inline-block px-5 py-2 bg-purple-50 text-purple-600 rounded-lg hover:bg-purple-100 transition-colors text-sm md:text-base">Book Appointment</a>
            </div>
          </div>
        </div>
            ...
            <div className="bg-purple-900 text-white rounded-2xl p-6 md:p-8">
              <div className="space-y-4">
                {[{
                  ...
                  answer: "We deliver within 2-5 business days in major Nigerian cities. You get tracking and real updates. No stories.",
                },
                {
                  question: "Can I pay on delivery?",
                  answer: "Yes, you can pay with Paystack, bank transfer, or cash/card on pickup at our Ibadan store.",
                },
                {
                  question: "Do you offer warranty?",
                  answer: "Every Dolftech laptop comes with at least 6 months warranty. We handle repairs/upgrades locally, no shipping abroad.",
                },
                {
                  question: "Can I visit your store before buying?",
                  answer: "Yes! You can test laptops, get honest advice, and pick up your order in person. Walk-ins and appointments welcome.",
                },
                {
                  question: "Do you offer bulk or student discounts?",
                  answer: "We give special pricing for students, schools, and bulk/corporate orders. Ask for a quote!",
                },
                {
                  question: "What if I have a problem after buying?",
                  answer: "Our support is always available via WhatsApp, phone, or in-store. We solve issues fast, no excuses.",
                }].map((faq, index) => (
                  <div
                    key={index}
          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg md:text-xl mb-8">
                Subscribe for laptop deals, tech tips, and exclusive offers for Nigerians. No spam, just value!
              </p>
