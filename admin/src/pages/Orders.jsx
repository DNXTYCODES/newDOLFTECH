      ...
      <div className="space-y-6">
        ...
        {orders.length > 0 &&
          orders.map((order, index) => (
            ...
            >
              <img
                className="w-14 h-14 object-contain rounded bg-cyan-50 border"
                src={assets.parcel_icon}
                alt=""
              />
                ...
                <div className="mb-2">
                  {order.items.map((item, idx) => {
                    ...
                    return (
                      <div
                        key={idx}
                        className="flex flex-wrap items-center gap-2 text-sm mb-1"
                      >
              ...
              <div className="flex flex-col gap-2 min-w-[120px]">
                ...
                <button
                  ...
                  onClick={() =>
                    window.open(`mailto:${order.address.email || ""}`)
                  }
